              ...
              <div className="space-y-6 text-center lg:text-left">
                <div>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-default-900 leading-tight">
                    Store your <span className="text-primary">files/folders</span> with
                    ease
                  </h1>
              ...
              <div className="flex justify-center order-first lg:order-last">
                <div className="relative w-64 h-64 md:w-80 md:h-80">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <FileIcon className="h-24 md:h-32 w-24 md:w-32 text-primary/70" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <Card className="border border-default-200 bg-default-50 shadow-sm hover:shadow-md transition-shadow sm:col-span-2 md:col-span-1 mx-auto sm:mx-0 max-w-md sm:max-w-full">
                <CardBody className="p-6 text-center">
                  ...
                  <p className="text-default-600">
                    Your files/folders, your eyes only.
                  </p>
                </CardBody>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <h2 className="text-lg font-bold">ZippyBox</h2>
            </div>
            <p className="text-default-500 text-sm">
              &copy; {new Date().getFullYear()} ZippyBox
            </p>
          </div>
        </div>
      </footer>
