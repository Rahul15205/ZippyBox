/**
 * Database Schema for ZippyBox
 *
 * This file defines the database structure for our ZippyBox application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our ZippyBox.
